    ...
    <x-slot name="header">
        ...
        <div class="de-header-row de-font">
            <div>
                ...
                <h1 class="de-title">Edit Feature</h1>
                <p class="de-subtitle">Update the details for {{ $feature->name }}.</p>
            </div>
            ...
            <div class="de-card-form__body">
                <form action="{{ route('features.update', $feature) }}" method="POST">
                    ...
                    <div class="de-form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name', $feature->name) }}" class="de-input"
                    ...
                    <div class="de-form-group">
                        ...
                        <textarea name="description" rows="4" class="de-input"
                            placeholder="Describe the feature details and benefits...">{{ old('description', $feature->description) }}</textarea>
                    </div>
